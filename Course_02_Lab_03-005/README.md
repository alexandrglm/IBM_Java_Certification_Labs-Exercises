# IBM Java Certification Exercise

**Course 2:** Java Beginners  
...
5. **05 - Exercise 1**
6. **06 - Exercise 2**
7. **07 - Exercise 3 - Full String Methods** (expanded)
...
## 11. `.join()`Working with Strings in Java
